...
public class Model {
	...
	private void search(List<PowerOutages> partial, int maxNumberOfYears, int maxHoursOfOutage) {
		...
		for(PowerOutages event : eventList) {
			//parziale non puo' contenere eventi duplicati
			if(!partial.contains(event)) {
				...
				//			-> questo filtro agisce come condizione di terminazione, le funzioni "ritorneranno" senza il bisodno di una return esplicita
